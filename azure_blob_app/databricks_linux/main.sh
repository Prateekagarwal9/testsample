...
databricks workspace import  -f DBC -l SCALA /home/site/wwwroot/azure_blob_app/databricks_linux/supplychain/Supply-Chain-Solution.dbc /Supply-Chain-Solution;
